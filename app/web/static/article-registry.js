...
export const ARTICLE_REGISTRY = [
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "可以作為理解相處模式的入口，但不應用來判定兩個人合不合。",
      },
      {
  ...
  },
  {
    ...
    description: "16 型人格把 MBTI 四組偏好組合成不同類型，適合作為理解特質、感情、工作與人際的入口；同一型仍會因情境和經驗而不同。",
    answer: "16 型人格能整理偏好差異，但只是入口，同一型仍會因情境不同。",
    tags: ["人格類型", "人際", "工作"],
  },
  {
    id: "MBTI-BASE-03",
    ...
    description: "MBTI 測驗適合當作自我理解入口，可整理偏好與互動模式；但結果會受狀態、題目理解和情境影響，不應當作診斷。",
  ...
  },
  {
    ...
    description: "夫妻宮可以作為觀察感情互動與關係模式的入口，但不能承諾婚姻、復合或特定對象結果。",
