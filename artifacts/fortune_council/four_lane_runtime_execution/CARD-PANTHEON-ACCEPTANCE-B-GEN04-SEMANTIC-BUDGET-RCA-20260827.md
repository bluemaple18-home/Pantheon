---
id: CARD-PANTHEON-ACCEPTANCE-B-GEN04-SEMANTIC-BUDGET-RCA-20260827
status: ready
...
- 只可寫本卡專屬 RESULT：`CARD-PANTHEON-ACCEPTANCE-B-GEN04-SEMANTIC-BUDGET-RCA-20260827-RESULT.md`。
- 只可寫本卡專屬 evidence 目錄：`pantheon_acceptance_b_gen04_semantic_budget_rca_20260827/`。
- 可寫 task-owned `/private/tmp/pantheon-acceptance-b-gen04-semantic-budget-rca-*` 暫存證據。
