#!/usr/bin/env python3
"""Run exact 23e runtime promotion commands and save bounded evidence."""
...
SOURCE_REPO = Path("/private/tmp/pantheon-gen05-release-23e-source-20260828")
EVIDENCE_DIR = MAIN_REPO / (
    "artifacts/fortune_council/four_lane_runtime_execution/"
    "pantheon_acceptance_b_gen05_production_release_23e_20260828"
)
...
TARGET_IDENTITY = "gate2-actor:23eab63ea31031094aa084faee0e5ff65d326533:gen05-lane-selector-lifecycle-repair-20260828"
...
TARGET_GENERATION = "g57-23eab63e-gen05-lane-selector-lifecycle-repair-20260828"
...
CAPACITY_RECEIPT = EVIDENCE_DIR / "promotion-capacity-guard-receipt-23e.json"
CAPACITY_RECEIPT_DIGEST = "83bf431b6cd5e955649483e58a37e0ef12344881f1bf1b72cd23df23f2412de0"
AUTHORIZATION_PAYLOAD = EVIDENCE_DIR / "authorization-payload-23e.json"
CORRELATION_ID = "pantheon-gen05-release-23e-20260828"
TRANSACTION_ROOT = Path("/Users/mattkuo/Documents/Pantheon-canary-runtime-v8/transactions/pantheon-gen05-release-23e-20260828")
...
def common_args() -> list[str]:
    ...
    write_json(EVIDENCE_DIR / "preserved-run-ids-23e.json", run_ids)
    args = [
        str(PYTHON),
        "-m",
...
def main() -> int:
    ...
    write_json(EVIDENCE_DIR / f"{args.command}-source-identity-23e.json", source_identity)
    ...
    return run(command, label=f"promotion-{args.command}-23e")
