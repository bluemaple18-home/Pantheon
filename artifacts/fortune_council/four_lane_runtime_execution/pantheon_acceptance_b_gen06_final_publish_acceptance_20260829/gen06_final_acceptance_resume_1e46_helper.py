...
SOURCE_REPO = Path("/private/tmp/pantheon-gen06-final-publish-source-1e46-20260829")
...
TARGET_SHA = "1e46c46426cf1662c1089cbf33dcf2ee54d437c4"
EXPECTED_CURRENT_ACTOR_SHA = "5704fa6077aa4187619fddc08d9c29cad2f2dabf"
EXPECTED_CURRENT_MANIFEST_DIGEST = "eb439da071f677f9be42311fe2db59ba2068db8c3dcf78b63cf6c4d8c609916e"
EXPECTED_TARGET_RUNTIME_DIGEST = "38f3a73b56cf9753b277b7e3ec52242f76aa7d81cf34784316a7197312921ce3"
...
TRANSACTION_ROOT = PRODUCTION_ROOT / "transactions/pantheon-gen06-final-publish-test-repair-1e46-20260829"
TARGET_IDENTITY = f"gate2-actor:{TARGET_SHA}:gen06-final-publish-test-repair-20260829"
TARGET_GENERATION = "g67-1e46c464-gen06-final-publish-test-repair-20260829"
TARGET_CONFIG_VERSION = "formal-runtime-v3-model-route-v1"
CAPACITY_RECEIPT = EVIDENCE / "resume-1e46-rule24-capacity-pre.json"
AUTHORIZATION_PAYLOAD = EVIDENCE / "resume-1e46-authorization-payload.json"
...
def write_authorization() -> None:
    payload = {
        ...
        "operation": "pantheon-gen06-final-publish-acceptance-resume-after-test-repair",
        "target_sha": TARGET_SHA,
        "parent_sha": EXPECTED_CURRENT_ACTOR_SHA,
        "run_id": RUN_ID,
        "allowed_mutations": [
            "push exact test-only repair sha to origin/main once",
            "formal runtime promotion from 5704 to 1e46",
...
def common_promotion_args(command: str) -> list[str]:
    ...
    write_json(EVIDENCE / "resume-1e46-preserved-run-ids.json", run_ids)
    write_json(
        EVIDENCE / "resume-1e46-promotion-input-summary.json",
        {
    ...
    args = [
        ...
        "--correlation-id",
        "pantheon-gen06-final-publish-test-repair-1e46-20260829",
    ]
...
def run_promotion(command: str, expected_plan_digest: str | None) -> int:
    ...
    label = f"resume-1e46-promotion-{command}"
