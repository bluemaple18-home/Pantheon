#!/usr/bin/env python3
"""唯讀 Repair evidence：隔離重播 optional 與 historical exact-run activation。"""
...
def main() -> int:
    ...
    fresh_green = (
        fresh_without_future_run["steps"][-1]["returncode"] == 0
        and fresh_without_future_run["stage"]["plist_count"] == 7
    ...
    return 0 if fresh_green and historical_green and before == after else 1
