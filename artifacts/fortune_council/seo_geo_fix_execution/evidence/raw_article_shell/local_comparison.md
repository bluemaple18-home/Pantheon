...
- 自己網站：http://127.0.0.1:8799
- 競品網站：https://news.click108.com.tw
- 產出時間：2026-07-12T05:40:57+00:00

## Score Delta

| 指標 | 自己 | 競品 | 判讀 |
|---|---:|---:|---|
| Schema depth | 100 | 20 | 我們領先，維持並擴大內容覆蓋。 |
| E-E-A-T | 100 | 64 | 我們領先，維持並擴大內容覆蓋。 |
| Citability | 84 | 40 | 我們領先，維持並擴大內容覆蓋。 |
| Entity | 100 | 65 | 我們領先，維持並擴大內容覆蓋。 |

## Endpoint / AI Crawler

| 項目 | 自己 | 競品 | 建議 |
|---|---|---|---|
| llms.txt | present | missing | 自己缺就先補；競品缺代表可做 GEO 超車。 |
| ai.txt | present | missing | 自己缺就補 AI 使用政策與品牌引用邊界。 |
...
- P1 GEO/AEO 檢查沒有發現 blocker，下一步看內容量、內鏈與 AI visibility 實測。
