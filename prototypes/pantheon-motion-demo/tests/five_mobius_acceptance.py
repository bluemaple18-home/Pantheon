...
BASE_URL = "http://127.0.0.1:5173/?studio=1&capture=1&prototype=five-mobius"
...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        for view in ("front", "orbit", "side"):
            ...
            output = EVIDENCE / f"five-mobius-{view}.png"
        ...
        output_json = EVIDENCE / "five-mobius-browser-evidence.json"
