...
PROVIDER_ADMISSION_CAP="${AGY_GEMINI_DAILY_PROVIDER_ADMISSION_CAP:-1200}"
...
if [[ "${PROVIDER_ADMISSION_CAP}" != "1200" ]]; then
  echo "AGY_GEMINI_DAILY_PROVIDER_ADMISSION_CAP 必須為 1200。" >&2
  exit 1
fi
