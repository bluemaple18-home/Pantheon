...
/usr/libexec/PlistBuddy -c "Set :ProgramArguments:4 ${REPO_ROOT}/.work/gemini-runner" "${TEMP_PLIST}"
...
/usr/libexec/PlistBuddy -c "Set :ProgramArguments:10 ${REPO_ROOT}/.work/gsc-copy" "${TEMP_PLIST}"
